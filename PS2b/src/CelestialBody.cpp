...
CelestialBody::CelestialBody(int x, int y, double v_x, double v_y, double mass, std::string filename)
...
{
    in >> body.r.x >> body.r.y >> body.v.x >> body.v.y >> body.mass >> body.filename;
    body.loadArtifacts();
    return in;
}
